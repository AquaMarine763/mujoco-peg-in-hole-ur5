...
- Multi-geometry status:
  ...
  - Next same-shape learner/controller step should keep v8 promoted and treat the final-insert adapter and macro recovery as diagnostics only. The useful next move is a better closed-loop final-insert data/teacher design before any broad matrix claim; do not promote v104-v108 or v112-v116 as default runtime behavior.
