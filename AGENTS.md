...
- Multi-geometry status:
  ...
  - Next same-shape learner/controller step should keep v8 promoted and treat the final-insert adapter as diagnostic only. The useful next move is a better closed-loop final-insert data/teacher design before any broad matrix claim; do not promote v104-v108, v112, v113, or v114 as default runtime behavior.
