...
- Current near-term plan:
  ...
  - gated approach adapter smoke status:
    ...
    - adapter artifact is still local: `D:\peg-in-hole-6yh\v63_adapter_v8_balanced_dagger\approach_adapter_v8_fullcrop_balanced_seed645_dagger_xy_override.pt`, size `341061` bytes, SHA256 `0788831FBC94E344865A35ACD96408C40D72D50521D2C668D86570F640EE53EB`
    - packaging the adapter into the repo was blocked by local Windows ACL on 2026-05-29. Next work should publish the adapter as a release asset or add it to the repo once ACL is fixed, then tag the code+artifact recipe
