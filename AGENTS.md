...
- Multi-geometry status:
  ...
  - Next same-shape learner/controller step should keep v8 promoted and treat the final-insert adapter and macro recovery as diagnostics only. The useful next move is targeted analysis/collection for the remaining `896007` high-Z `align_hover` timeout, not further broad handoff threshold widening; do not promote v104-v108 or v112-v119 as default runtime behavior.
