...
- Multi-geometry status:
  ...
  - Next same-shape learner/controller step should keep v8 promoted and focus on square-square narrow-clearance final insertion/tilt/contact stability, not approach adapter training. Avoid broad threshold scans or promoting v104-v108; prefer a default-off guarded eval hook for the v111 final-insert adapter or more fresh-seed stuck traces before any broad matrix claim.
