...
- Multi-geometry status:
  ...
  - Next same-shape learner/controller step should keep v8 promoted and focus on square-square narrow-clearance final insertion/tilt/contact stability, not approach adapter training. Avoid broad threshold scans or promoting v104-v107; prefer a targeted narrow-square insertion curriculum or a learned/trace-derived final-insert correction policy.
