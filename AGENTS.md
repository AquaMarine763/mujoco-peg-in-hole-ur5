...
- Multi-geometry status:
  ...
  - Next same-shape learner/controller step should keep v8 promoted and treat the final-insert adapter and macro recovery as diagnostics only. The useful next move is broader fresh-seed validation of the full retry6 v120 stack, not further broad handoff threshold widening; do not promote v104-v108 or v112-v119 as default runtime behavior.
