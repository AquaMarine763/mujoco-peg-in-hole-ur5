...
- Multi-geometry status:
  ...
  - Next same-shape learner/controller step should keep v8 promoted and treat the final-insert adapter as diagnostic only. The useful next move is to collect/analyze more fresh narrow-square stuck traces or train a better closed-loop final-insert adapter before any broad matrix claim; do not promote v104-v108 or v112 as default runtime behavior.
