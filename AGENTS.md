...
- Multi-geometry status:
  ...
  - Next same-shape learner/controller step should keep v8 promoted and focus on square-square narrow-clearance final insertion/tilt/contact stability, not approach adapter training. Avoid broad threshold scans or promoting v104-v108; prefer collecting more fresh-seed stuck traces, then either retrain the final-insert adapter or wire it into guarded eval behind a default-off diagnostic switch.
