...
- Multi-geometry status:
  ...
  - Current conclusion: keep promoted v8 as the stable baseline; treat v138/v139 as a promising diagnostic, not a stable tag yet. The remaining narrow square-square bottleneck is high-Z `square_fast_settle` under negative tilted-clearance margin where the peg stays wedged above the success band. Next work should focus on final-servo reactivation/supervision or better final-insert teacher labels, not retry count or blind high-Z down-push.
