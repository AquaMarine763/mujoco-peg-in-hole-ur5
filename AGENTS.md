...
- Multi-geometry status:
  ...
  - Next same-shape learner step should keep v8 as the promoted adapter and move to a harder same-shape generalization gate: larger mixed seeds, wider shape-orientation/randomization coverage, or tightening the temporary triangle/slot/rectangular geometry curriculum.
