...
- UR5e controller status:
  ...
  - Do not promote frame_skip 20, fixture-clearance lift, or wider `guarded_align_xy_tolerance=0.030`; these did not improve the Kp2 candidate. Next work should promote `0.03/64 + Kp2` as the controller milestone, then target the two remaining timeout classes.
