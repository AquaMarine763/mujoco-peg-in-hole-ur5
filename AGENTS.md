...
- Multi-geometry status:
  ...
  - Next same-shape learner/controller step should keep v8 promoted and focus on square-square narrow-clearance final insertion/tilt, not approach adapter training. Avoid broad orientation-weight scans; prefer a targeted narrow-square insertion curriculum or a deliberate square contact/tilt recovery design.
