...
- Output: `datasets\visual_yaw_v1_tight_yaw_key_focus_8k_stratified_crop_wider.npz`
- Samples: `8192`
...
- Mean/max IK error: `0.000009` / `0.003874`
- Mean/max abs yaw error deg: `62.039` / `179.956`
