...
`guard_enabled`, `guard_active`, `policy_action_*`, `guarded_action_*`,
`final_action_*`, `raw_action_*`, and `safe_action_*`.
...
| hard bucket | 90005 | guarded geometry blend 0.75 | 1 | 0 | 34 | 34 | 0.00479 | 0.00768 | `results/policy_inference_hard_bucket_guarded_blend075_smoke.csv` |
