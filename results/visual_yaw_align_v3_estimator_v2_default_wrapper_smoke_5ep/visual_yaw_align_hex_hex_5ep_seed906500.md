...
- Frame skip: `10`
- Step trace CSV: `results\visual_yaw_align_v3_estimator_v2_default_wrapper_smoke_5ep\visual_yaw_align_hex_hex_5ep_seed906500_steps.csv`
...
- IK continuity/wrist continuity/max wrist target delta deg/nearest wrist equivalent: `0.001/0.003/None/False`
...
- Guard visual yaw-align enabled/model/profile models/mode/weight: `True/results\visual_yaw_estimator_v1_tight_yaw_triangle_hex_wrong_basin_8k_plus_rollout_balanced.pt/['hex_hex:results/visual_yaw_estimator_v1_tight_yaw_triangle_hex_wrong_basin_8k_plus_rollout_balanced_plus_hex_failures_v1.pt']/pose_tip_priority/0.9`
- Guard visual yaw-align gates XY/Z/contact/raw/std/deadband/max correction/block: `0.14/0.006-0.16/0/0.08/18.0:16.0/0.5/90.0/True:2.0`
...
- Guard visual yaw-align shortest / temporal smoothing / wrist-limited equivalent target: `False/False/False:hex_hex:180.0`
...
- Guard visual yaw-align hold XY enabled/profiles/tolerance/action: `True/hex_hex/0.0025/0.005`
- Guard visual yaw-align target hold enabled/profiles/steps/arm yaw/release yaw/XY/Z/block: `True/hex_hex/180/3.0/8.0/0.18/0.0-0.16/False`
- Guard visual yaw-align low-visibility brake enabled/profiles/yaw/XY/Z/up/flush: `True/hex_hex/12.0/0.02/0.08/0.008/True`
- Guard visual yaw-align large-XY/low-Z brake enabled/profiles/XY/Z/up/hold/flush: `False/hex_hex/0.06/0.01/0.008/0/False`
...
- Guard visual yaw-align aligned descent enabled/yaw/XY/Z/steps/visible/down/XY action: `True/2.0/0.02/0.01-0.09/3/True/0.0035/0.004`
- Guard visual yaw-align aligned descent latch steps/release XY/yaw/Z: `90/0.02/4.0/0.0-0.095`
- Guard visual yaw-align freeze aligned target enabled/profiles/steps/yaw/stable/source/block-until-XY/release yaw/XY/Z/visible: `False/hex_hex/0/3.0/1/target/False:0.02/8.0/0.02/0.0-0.18/False`
...
- Guard final servo near-miss steps/XY/Z/contact/tilt/max steps/max down/bias: `30/0.0068/0.06/1/8.0/500/0.003/(0.0035, 0.0035)`
...
| --- | --- | --- | --- | --- | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| hard_full_light_bucket | full_light_geometry | guarded | normal | all | normal | True | 1.000 | 0.000 | 0.000 | 158.288 | 246.8 | 142.8 (0.58) | 0.0 (0.00) | 0.0 (0.00, down 0.00) | 0.0 (0.00, latched 0.00, block 0.00) | 0.0 (0.00) | 0.0 (0.00) | 0.0 (0.00) | 0.0 (0.00, trig 0.00, rel 0.00) | 0.0 (0.00, trig 0.00, rel 0.00) | 56.8 (0.23) | 0.0 (0.00) | 0.0 | 0.0 (0.00, trig 0.00) | 13.0 (0.05, block 4.8) | 28.6 (0.12, trig 0.80, rel 0.40) | 0.0 (0.00, trig 0.00, rel 0.00) | 70.0 (0.28, trig 1.00, rearm 0.00, rec 0.00) | 50.0 (0.71) | 0.00170 | 0.00924 |
