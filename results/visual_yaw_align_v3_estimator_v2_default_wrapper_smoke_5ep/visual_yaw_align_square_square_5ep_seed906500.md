...
- Frame skip: `10`
- Step trace CSV: `results\visual_yaw_align_v3_estimator_v2_default_wrapper_smoke_5ep\visual_yaw_align_square_square_5ep_seed906500_steps.csv`
...
- Guard visual yaw-align enabled/model/profile models/mode/weight: `False/None/None/pose_tip_priority/0.18`
- Guard visual yaw-align gates XY/Z/contact/raw/std/deadband/max correction/block: `0.014/0.01-0.08/0/0.08/18.0:16.0/2.0/10.0/False:6.0`
...
- Guard visual yaw-align hold XY enabled/profiles/tolerance/action: `False/square_square,triangle_triangle,hex_hex,rectangular_key/0.003/0.003`
- Guard visual yaw-align target hold enabled/profiles/steps/arm yaw/release yaw/XY/Z/block: `False/square_square,triangle_triangle,hex_hex,rectangular_key/0/3.0/180.0/0.18/0.0-0.18/False`
- Guard visual yaw-align low-visibility brake enabled/profiles/yaw/XY/Z/up/flush: `False/square_square,triangle_triangle,hex_hex,rectangular_key/12.0/0.02/0.08/0.008/False`
...
- Guard visual yaw-align aligned descent enabled/yaw/XY/Z/steps/visible/down/XY action: `False/1.0/0.02/0.01-0.18/1/False/0.004/0.005`
- Guard visual yaw-align aligned descent latch steps/release XY/yaw/Z: `0/0.02/8.0/0.0-0.18`
- Guard visual yaw-align freeze aligned target enabled/profiles/steps/yaw/stable/source/block-until-XY/release yaw/XY/Z/visible: `False/square_square,triangle_triangle,hex_hex,rectangular_key/0/3.0/1/target/False:0.02/8.0/0.02/0.0-0.18/False`
...
| --- | --- | --- | --- | --- | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| hard_full_light_bucket | full_light_geometry | guarded | normal | all | normal | True | 1.000 | 0.000 | 0.000 | 249.011 | 241.4 | 151.6 (0.63) | 0.0 (0.00) | 0.0 (0.00, down 0.00) | 0.0 (0.00, latched 0.00, block 0.00) | 0.0 (0.00) | 0.0 (0.00) | 0.0 (0.00) | 0.0 (0.00, trig 0.00, rel 0.00) | 0.0 (0.00, trig 0.00, rel 0.00) | 114.4 (0.47) | 0.0 (0.00) | 0.0 | 0.0 (0.00, trig 0.00) | 0.0 (0.00, block 0.0) | 0.0 (0.00, trig 0.00, rel 0.00) | 0.0 (0.00, trig 0.00, rel 0.00) | 95.0 (0.39, trig 1.00, rearm 0.00, rec 0.20) | 68.6 (0.72) | 0.00173 | 0.00941 |
