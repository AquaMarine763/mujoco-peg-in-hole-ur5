...
- Frame skip: `10`
- Step trace CSV: `results\visual_yaw_align_v3_estimator_v2_default_wrapper_smoke_5ep\visual_yaw_align_triangle_triangle_5ep_seed906500_steps.csv`
...
- IK continuity/wrist continuity/max wrist target delta deg/nearest wrist equivalent: `0.001/0.003/8.0/True`
- Initial shape yaw hold enabled/profiles/steps/XY/Z/mode/weight/block: `True/rectangular_key/650/0.18/0.03-0.3/pose_tip_priority/0.08/False`
...
- Guard visual yaw-align enabled/model/profile models/mode/weight: `True/results\visual_yaw_estimator_v1_tight_yaw_key_focus_8k_stratified_low_z_crop_high.pt/None/pose_tip_priority/0.9`
- Guard visual yaw-align gates XY/Z/contact/raw/std/deadband/max correction/block: `0.14/0.006-0.16/0/0.03/18.0:16.0/0.5/90.0/True:2.0`
...
- Guard visual yaw-align profile max-correction overrides: `['rectangular_key:20.0']`
- Guard visual yaw-align shortest / temporal smoothing / wrist-limited equivalent target: `False/False/False:square_square,triangle_triangle,hex_hex,rectangular_key:180.0`
...
- Guard visual yaw-align absolute shape target enabled/profiles/abs/delta/jump/IK slack/joint slack: `True/triangle_triangle/160.0/95.0/70.0/0.004/0.04`
- Guard visual yaw-align absolute shape target descent unlock enabled/profiles/steps/XY/Z/actions: `True/triangle_triangle/20/0.005/0.01-0.09/0.004:0.003`
...
- Guard visual yaw-align hold XY enabled/profiles/tolerance/action: `True/triangle_triangle/0.0025/0.006`
- Guard visual yaw-align target hold enabled/profiles/steps/arm yaw/release yaw/XY/Z/block: `True/triangle_triangle/120/65.0/65.0/0.18/0.0-0.16/True`
- Guard visual yaw-align low-visibility brake enabled/profiles/yaw/XY/Z/up/flush: `True/square_square,triangle_triangle,hex_hex,rectangular_key/12.0/0.02/0.08/0.008/True`
- Guard visual yaw-align large-XY/low-Z brake enabled/profiles/XY/Z/up/hold/flush: `False/square_square,triangle_triangle,hex_hex,rectangular_key/0.06/0.01/0.008/0/False`
...
- Guard visual yaw-align post-yaw reapproach enabled/profiles/attempts/step/trigger XY/Z/yaw/visible/lift/recenter/descent/actions/reset/realign/flush: `False/triangle_triangle/1/0/0.018-0.18/0.03-0.12/12.0/False/0.095:0.006:45/0.006:3:180/10.0:220:0.0025/0.006:0.006/False/False:0.008:0.055:True/False`
...
- Guard visual yaw-align re-acquire enabled/profiles/attempts/step/trigger XY/Z/yaw/trigger visible-stable/xy-gate/centered/reset trigger-release/lift/recenter/actions/lift XY/flush/relaxed yaw/descent: `False/rectangular_key/0/700/0.02-0.18/0.0-0.09/45.0/False:False:3:12.0/False:0.08/False:-1:0.018:0.0-0.05:120.0:0.08:18.0:16.0:False:False/True:False/0.115:0.006:45/0.014:90/0.006:0.006/False:0.004/False/False:30.0:45.0:0.05-0.13:False:False:3:12.0:False/False:8.0:0.035:0.025-0.13:0.003`
- Guard visual yaw-align centered high-yaw reapply latch steps: `0`
- Guard visual yaw-align centered high-yaw local hold enabled/trigger re-acquire/steps/max correction: `False/True/80/25.0`
- Guard visual yaw-align wrong-basin hold enabled/profiles/yaw/visible/stable/steps/release XY/max XY/Z/action/block/flush: `False/rectangular_key/120.0/False/False:3:12.0/160/8.0:0.018/0.03/0.0-0.14/0.008/False/False`
...
- Guard visual yaw-align freeze aligned target enabled/profiles/steps/yaw/stable/source/block-until-XY/release yaw/XY/Z/visible: `True/triangle_triangle/260/8.0/2/target/True:0.02/65.0/0.18/0.0-0.18/False`
...
| --- | --- | --- | --- | --- | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| hard_full_light_bucket | full_light_geometry | guarded | normal | all | normal | True | 1.000 | 0.000 | 0.000 | 515.585 | 267.0 | 266.8 (1.00) | 0.0 (0.00) | 0.0 (0.00, down 0.00) | 0.0 (0.00, latched 0.00, block 0.00) | 0.0 (0.00) | 0.0 (0.00) | 0.0 (0.00) | 0.0 (0.00, trig 0.00, rel 0.00) | 0.0 (0.00, trig 0.00, rel 0.00) | 92.2 (0.35) | 0.0 (0.00) | 0.0 | 0.0 (0.00, trig 0.00) | 26.4 (0.10, block 93.4) | 77.6 (0.29, trig 1.00, rel 0.00) | 0.0 (0.00, trig 0.00, rel 0.00) | 153.4 (0.57, trig 1.00, rearm 0.00, rec 0.00) | 50.4 (0.33) | 0.00183 | 0.00929 |
